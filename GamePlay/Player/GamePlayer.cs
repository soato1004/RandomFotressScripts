...
namespace RandomFortress.Game
{
    public class GamePlayer : MonoBehaviour, IPunObservable
    {
        ...
        private const int TOTAL_TOWER_POS = 20;
        private const int TOTAL_TOWERS = 9;
        ...
        public void Awake()
        {
            ...
            TowerFixPos = new Transform[TOTAL_TOWER_POS];
        ...
        public void BuildRandomTower()
        {
            ...
            do
            {
                posIndex = Random.Range(0, TOTAL_TOWER_POS-1);
            } while (Towers[posIndex] != null);

            // 타워 랜덤 선택
            int towerIndex = 6;//1 + Random.Range(0, 9);
        ...
        {
            return tilemap.GetCellCenterWorld(GameManager.Instance.roadWayPoints[index]);
        }
