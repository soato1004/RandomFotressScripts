...
namespace RandomFortress
{
    public class ObjectPoolManager : Singleton<ObjectPoolManager>
    {
        ...
        // 오브젝트풀들을 관리할 딕셔너리
        private SerializedDictionary<string, IObjectPool<GameObject>> ojbectPoolDic = new SerializedDictionary<string, IObjectPool<GameObject>>();

        // 오브젝트풀에서 오브젝트를 새로 생성할때 사용할 딕셔너리
        private SerializedDictionary<string, GameObject> goDic = new SerializedDictionary<string, GameObject>();

        public override void Reset()
        {
            JustDebug.LogColor("ObjectPoolManager Reset");
        }
