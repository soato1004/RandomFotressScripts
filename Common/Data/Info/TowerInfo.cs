...
namespace RandomFortress.Data
{
    ...
    public class TowerInfo
    {
        ...
        // public int criticalChance = 0; // 치명타확률. x/100 확률로 나옴
        // public int criticalDamage = 0; // 치명타피해. x/100배.
        public int[] dynamicData = { 0, 0, 0 }; // 타워별로 필요한 정보를 이곳에 저장. 각 타워 클래스에 사용되는 데이터정의 기재
