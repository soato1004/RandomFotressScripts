        ...
        void UpdateScroll()
        {
            ...
            switch (SelectTap)
            {
                case CardCollection.Tower:
                    Dictionary<int, TowerData> TowerDatas = DataManager.Instance.TowerDataDic;
                ...
                case CardCollection.Skill:
                    Dictionary<int, SkillData> SkillDatas = DataManager.Instance.SkillDataDic;
        ...
        public void OnItemClick(int index)
        {
            switch (SelectTap)
            {
                case CardCollection.Tower:
                    ...
                    MainManager.Instance.account.TowerDeckAddOrRemove(towerIndex);
                    UpdatePlayerDeck();
                    break;
                
                case CardCollection.Skill:
                    int skillIndex = items[index].itemIndex;
                    MainManager.Instance.account.SkillDeckAddOrRemove(skillIndex);
                    UpdatePlayerDeck();
                    break;
            }
        }
