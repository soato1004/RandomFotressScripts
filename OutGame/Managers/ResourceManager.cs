    ...
    public class ResourceManager : Singleton<ResourceManager>
    {
        ...
        public GameObject GetMonster(int i)
        {
            if (DataManager.Instance.MonsterStateDic.ContainsKey(i))
            {
                ...
                JTDebug.LogError("Monster "+i+" Not Found");
                return null;
            }
            
            JTDebug.LogError("ScriptableObject Monster "+i+" Not Found");
            return null;
        }
        ...
        public Sprite GetTower(int towerIndex, int tier, string imgName = "")
        {
            if (imgName == "")
            {
                ...
                imgName = nameMath[towerIndex-1] + "_" + tier;
            }

            return GetSprite("Tower_Atlas" , imgName);
        } 
        
        public Sprite GetSkill(int skillIndex, string imgName = "")
        {
            return GetSprite("Skill_Atlas" , imgName);
        } 
        ...
        public Sprite GetSprite(string atlasName, string imgName)
        {
            ...
            JTDebug.LogError("atlasName "+atlasName+" Not Found");
            return null;
        }
